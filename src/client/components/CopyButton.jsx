  ...
  async function handleCopy() {
    try {
      ...
      if (tableRef?.current) {
        ...
        const th = 'border:1px solid #4472C4;padding:4px 10px;background:#4472C4;color:#ffffff;text-align:left;font-family:Aptos,Calibri,Arial,sans-serif;font-size:11pt;font-weight:600;white-space:nowrap;'
        const td0 = 'border:1px solid #4472C4;padding:4px 10px;color:#000000;background:#ffffff;text-align:left;font-family:Aptos,Calibri,Arial,sans-serif;font-size:11pt;white-space:nowrap;'
        const td1 = 'border:1px solid #4472C4;padding:4px 10px;color:#000000;background:#D9E1F2;text-align:left;font-family:Aptos,Calibri,Arial,sans-serif;font-size:11pt;white-space:nowrap;'
